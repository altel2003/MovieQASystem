...
class Question():
    ...
    def init_config(self):
        ...
        # 读取问题模板
        with(open("./static/question_classification.txt","r",encoding="utf-8")) as f:
    ...
    def question_posseg(self):
        jieba.load_userdict("./static/userdict3.txt")
    ...
    def query_template(self):
        ...
        try:
            ...
            answer=random.choice(["我也还不知道！", "啊！？", "我没明白你的问题……换一个吧！","我……听不太懂"])
        return answer
